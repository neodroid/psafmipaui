...
import React from 'react'
    ...
    <Flex justifyContent="center" alignItems="center" w="100%" bg="white">
        ...
        >
            ...
            >
                <Heading mb="2" as="h1" fontSize={["1.875rem", "2rem"]} letterSpacing={".1rem"}  fontFamily="default" fontWeight="bold" color="black"> POSISI, <Link color="#2F80ED">POTENSI{" "}</Link >DAN PERAN</Heading>
